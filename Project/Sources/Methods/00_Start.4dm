...
Case of 
	...
	Else 
		...
		$options.title:="set the height of headers and footers to fixed values?"
		
		$options.blog:="blog.4d.com"
		$options.info:="Managing headers and footers heights"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1800"  // 18R2 means 18R2   1801 means 18.1 (do not use !)
